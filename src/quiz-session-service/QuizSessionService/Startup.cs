...
namespace QuizSessionService
{
    public class Startup
    {
        ...
        public virtual void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddTransient<QuizSession>();
            services.AddHostedService<RedisSubscribeService>();
            services.AddSingleton<IMessageBus, RedisPubSub>();

            services.AddScoped<Services.QuizSessionService>();



            AddDatabase(services, new RedisSetting
            {
                Host = Env.REDIS_HOST,
                Port = Env.REDIS_PORT,
        ...
        private IServiceCollection AddDatabase(IServiceCollection services, RedisSetting setting)
        {
            ...
            services.AddScoped<IQuizSessionQuery>(sp => sp.GetRequiredService<RedisDbContext>());
            services.AddScoped<IEventStore>(sp => sp.GetRequiredService<RedisDbContext>());
